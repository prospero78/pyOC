...
class тМодуль(тСекция):
	...
	def Секции_Разбить(сам):
		...
		парам = {}
		парам['секция'] = "СЕКЦИЯ"
		парам['слова'] = сам.__слова
		сам.__импорт = тИмпорт(парам)
		сам.__слова = {}
