...
class тСекция:
	__slots__ = ("ошс", "__оберон", "__конс", "__секция", "слова_модуля",\
					"слова_секции", "бСекцияЕсть", "__слово_конец")
	def __init__(сам, пОберон, пДанные:dict)->None:
		def Слова_Проверить():
			if type(пДанные['слова']) != dict:
				...
				сам.ошс.ОшВнутр("__init__()", стрОш)
				return
	...
	def Конец_Уст(сам, пСлово):
		...
		if сам.__слово_конец != None:
			стрОш = "сам.__слово_конец уже установлено" + сам.__слово_конец.стрИсх
