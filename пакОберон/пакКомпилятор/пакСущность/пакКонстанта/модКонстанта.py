...
class тКонстанта:
	...
	def имя(сам) -> str:
		if сам.__имя == "":
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тКонстанта.имя: ошибка компилятора. Имя константе не присвоено!")
			return ""
		return сам.__имя
	...
	def модуль(сам)-> str:
		if сам.__модуль_имя == "":
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тКонстанта.модуль: ошибка компилятора. Имя модулю не присвоено!")
			return ""
	...
	def тип(сам) -> str:
		if сам.__тип == "":
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тКонстанта.тип: ошибка компилятора. Тип константе не присвоен!")
			return ""
		return сам.__тип
	...
	def знач(сам) -> str:
		if сам.__знач == "":
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тКонстанта.знач: ошибка компилятора. Значение константе не присвоено!")
			return ""
		return сам.__знач
