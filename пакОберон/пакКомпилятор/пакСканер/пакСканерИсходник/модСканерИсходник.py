...
class тСканерИсходник:
	def __init__(сам, пОберон:str, пИмяФайла : str)->None:
		...
		if сам.__исх.бОшВнутр:
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тСканерИсходник.__init__(): ошибка компилятора. При вызове тСканерИсхТекст")
			return
		if сам.__исх.бОшИсх:
			сам.__бОшИсх = True
			сам.__конс.Ошибка("тСканерИсходник.__init__(): ошибка исходника. При вызове тСканерИсхТекст")
			return

		# хранит строки исходного текста
		сам.строки :тСканерИсхСтроки = тСканерИсхСтроки(пОберон, сам.__исх.стрИсх)
		if сам.строки.бОшВнутр:
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тСканерИсходник.__init__(): ошибка компилятора. При вызове тСканерИсхСтроки")
			return
		...
		if сам.коорд.бОшВнутр:
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тСканерИсходник.__init__(): ошибка компилятора. При вызове тКоордИзм")
			return
	...
	def __Слово_Добав(сам, пСлово : тСлово)->None:
		...
		if слово.бОшВнутр:
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тСканерИсходник: ошибка компилятора. Ошибка при добавлении тСлово")
			return
		if слово.бОшИсх:
			сам.__бОшВнутр = True
			сам.__конс.Ошибка("тСканерИсходник: ошибка исходника. Ошибка при добавлении тСлово")
			return
	...
	def Комментарии_Выкинуть(сам)->None:
		...
		def Коммент_Выкинуть():
			...
			if лцУровень != 0:
				стрСообщ :str= "тСканерИсходник.Комментарии_Выкинуть(): ошибка исходника. Открытие и закрытие комментариев в модуле не сбалансировано, лцУровень=" + str(лцУровень)
				сам.__бОшИсх = True
