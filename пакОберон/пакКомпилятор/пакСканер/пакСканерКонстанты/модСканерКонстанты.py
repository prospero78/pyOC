...
class тСканерКонстанты(тСекцияКонст):
	...
	def __Обработать(сам):
		...
		if сам.__ЕслиКонстанты():
			if сам.__ЕслиСекцияНеПусто():
				if сам.__бОшВнутр:
					сам.__конс.ОшВнутр("тСканерКонстанты: ошибка компилятора. Ошибка при обнаружении секции")
					return
				if сам.__бОшИсх:
					сам.__конс.Ошибка("тСканерКонстанты: ошибка исходника. Ошибка при обнаружении секции")
					return
				сам.__ЕслиСекцияОграничен()
				if сам.__бОшВнутр:
					сам.__конс.ОшВнутр("тСканерКонстанты: ошибка компилятора. Ошибка при обнаружении конца секции")
					return
				if сам.__бОшИсх:
					сам.__конс.Ошибка("тСканерКонстанты: ошибка исходника. Ошибка при обнаружении конца секции")
					return
				сам.СловаСекции_Получить()
				if сам.__бОшВнутр:
					сам.__конс.ОшВнутр("тСканерКонстанты: ошибка компилятора. Ошибка при получении слов секции")
					return
				if сам.__бОшИсх:
					сам.__конс.Ошибка("тСканерКонстанты: ошибка исходника. Ошибка при получениислов секции")
					return
	...
	def __ЕслиСекцияНеПусто(сам)->bool:
		...
		if type(слово) != тСлово:
			стрОш = "тКонст: ошбика компилятора. Слово должно быть тСлово, type="+str(type(слово))
	...
	def __ЕслиСекцияОграничен(сам)->None:
		...
		while (not бМаркер) and (цСловаСчёт < (len(сам.слова_модуля))):
			...
			if type(слово) != тСлово:
				сам.__конс.ОшВнутр("тКонстанты: ошибка компилятора. Слово должно быть тСлово, type="+str(type(слово)))
				return
