...
class тСканер:
	def __init__(сам, пОберон, пФайлИмяИсх:str) -> None:
		...
		if исх.ош.бВнутр:
			сам.ош.Внутр("__init__()", "При вызове тСканерИсходник")
			return
		if исх.ош.бИсх:
			сам.ош.Исх("__init__()", "При вызове тСканерИсходник")
			return
		модуль = тСканерМодуль(пОберон, исх.Парам_Получ())
		if модуль.ош_.бВнутр:
			сам.ош.Внутр("__init__()", "При вызове тСканерМодуль")
			return
		if модуль.ош_.бИсх:
			сам.ош.Исх("__init__()", "При вызове тСканерМодуль")
			return
		...
		if импорт.ош_.бВнутр:
			сам.ош.Внутр("__init__()", "При вызове тСканерИмпорт")
			return
		if импорт.ош_.бИсх:
			сам.ош.Исх("__init__()", "При вызове тСканерИмпорт")
			return
		...
		if конст.ош.бВнутр:
			сам.ош.Внутр("__init__()", "При вызове тСканерКонстанты")
			return
		if конст.ош.бИсх:
			сам.ош.Исх("__init__()", "При вызове тСканерКонстанты")
			return
		...
		if типы.ош.бВнутр:
			сам.ош.Внутр("__init__()", "При вызове тСканерТипы")
			return
		if типы.ош.бИсх:
			сам.ош.Исх("__init__()","При вызове тСканерТипы")
			return
		...
		if перем.ош.бВнутр:
			сам.ош.Внутр("__init__()", "При вызове тСканерПеременные")
			return
		...
		if процедуры.ош.бИсх:
			сам.ош.Исх("__init__()", "При вызове тСканерПроцедуры")
			return
