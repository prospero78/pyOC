...
class тКомпилер:
	...
	def Выполнить(сам, пФайлИсхИмя:str):
		...
		if сканер.ош.бВнутр:
			сам.ош.Внутр("Выполнить()", "При вызове тСканер")
			return
		if сканер.ош.бИсх:
			сам.ош.Исх("Выполнить()", "При вызове тСканер")
			return

		анализ = тАнализ(сам.__оберон, сканер.Секции_Получить())
		if анализ.ош.бВнутр:
			сам.ош.Внутр("Выполнить()", "При вызове тАнализ")
			return
		if анализ.ош.бИсх:
			сам.ош.Исх("Выполнить()", "При работе тАнализ")
			return

		разбор = тРазбор(анализ.данные)
		if разбор.ош.бВнутр:
			сам.ош.Внутр("Выполнить()", "Ошибка тРазбор")
			return
		if разбор.ош.бИсх:
			сам.ош.Исх("Выполнить()", "При работе тРазбор")
			return
