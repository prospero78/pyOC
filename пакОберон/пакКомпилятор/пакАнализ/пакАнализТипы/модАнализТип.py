...
class тАнализТип(тАнализТипБазовый):
	...
	def __ЧастныйПредок_Проверить(сам, пСлово):
		...
		assert сам.__врем_предок == тРод.сБезТипа, "тАнализТип: предок уже назначен, предок=" + сам.__врем_предок+ слово_имя.стрИсх
		сам.__врем_предок = ""
	...
	def Паспорт_Печать(сам):
		print("тАнализТип: имя_типа=", сам.__имя)
