...
class тАнализИмпорт(тАнализБаза):
	def __init__(сам, пОберон, пДанные:dict)->None:
		...
		сам.__конс.Отладить("тАнализИмпорт.__init()")
		...
		if сам.бОшВнутр_АнализБаза:
			сам.__бОшВнутр = True
			сам.__конс.ОшВнутр("тАнализИмпорт.__init__(): внутренняя ошибка При вызове тАнализБаза")
			return
	...
	def __Импорт_Разобрать(сам)->None:
		...
		while len(сам.слова_секции) > 0:
			...
			if имп_модуль.бОшВнутр_АнализИмпорт:
				сам.__бОшВнутр = True
				сам.__конс.ОшВнутр("тАнализИмпорт): внутренняя ошибка При вызове тАнализИмпорт")
				return
