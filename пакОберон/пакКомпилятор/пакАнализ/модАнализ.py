...
class тАнализ:
	def __init__(сам, пОберон, пДанные:dict)->None:
		...
		if True: # анализ импорта
			...
			if импорт.бОшВнутр:
				сам.__бОшВнутр = True
				сам.__конс.ОшВнутр("тАнализ.__init__(): ошибка компилятора. При вызове тАнализИмпорт")
				return
		...
		if True: # анализ констант
			...
			if конст.бОшВнутр:
				сам.__бОшВнутр = True
				сам.__конс.ОшВнутр("тАнализ.__init__(): ошибка компилятора. При вызове тАнализКонст")
				return
		...
		if True: # анализ типов
			...
			if типы.бОшВнутр:
				сам.__бОшВнутр = True
				сам.__конс.ОшВнутр("тАнализ.__init__(): ошибка компилятора. При вызове тАнализТипы")
				return
		...
		if True: # анализ переменных
			...
			if перем.бОшВнутр:
				сам.__бОшВнутр = True
				сам.__конс.ОшВнутр("тАнализ.__init__(): ошибка компилятора. При вызове тАнализПерем")
				return
