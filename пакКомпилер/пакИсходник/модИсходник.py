...
class тИсходник:
   def __init__(self, root, имя_файла):
      ...
      self.конс.Проверить(усл, _текст)
      ...
      self.коорд = тКоордИсх(1, 0) # общая позиция в исходном тексте
   ...
   def Тег_Добав(self, имя):
      ...
      """
      коорд = тКоорд(self.__root, self.коорд.стр, self.коорд.поз)
   ...
   def Теги_Печать(self):
      for keys in self.__теги:
         ...
         self.конс.Печать(str(тег))

   def Комментарии_Выкинуть(self):
      """
   ...
   def Обработать(self):
      ...
      #print('===Грязные теги===')
      #self.Теги_Печать()
      self.Комментарии_Выкинуть()
      #self.конс.Печать("===Чистые теги===")
      #self.Теги_Печать()
