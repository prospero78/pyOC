...
class тСлово:
	...
	def __init__(сам, пИсх, пСтрока):
		...
		сам.коорд = тКоордФикс(сам.__корень, пИсх.коорд.стр, пИсх.коорд.поз)

		сам.__стрИсх = пИсх.строки(пИсх.коорд.стр)
	...
	def стрИсх(сам):
		...
		стр_ном=str(сам.коорд.стр)
		while len(стр_ном) < 4:
			стр_ном = " " + стр_ном
		стр_указ = (len(стр_ном)+1) * "-" + "-" * сам.коорд.поз + "^"
