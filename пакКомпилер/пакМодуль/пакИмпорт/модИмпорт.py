...
class тИмпорт:
	...
	def ЕслиИмпортОграничен(сам):
		...
		def Слово_Контроль():
			...
			сам.__бМаркер = (сам.__слово_врем.слово == ";")
	...
	def Импорт_Разобрать(сам):
		...
		def Модуль_Доб(слово):
			...
			assert (слово.слово != None or слово.слово != ""), "тИмпорт: Имя модуля не может быть None или пустым"

			модуль = тМодульИмя("", слово.слово, сам.__цМодулиВсего)
		...
		def Алиас_Добавить(пАлиас, пМодуль):
			...
			assert пАлиас.слово != None, "тИмпорт: Имя алиаса не может быть None"
			...
			assert пМодуль.слово != None or пМодуль.слово != "", "тИмпорт: Имя модуля не может быть None или пустым"
			модуль = тМодульИмя(пАлиас.слово, пМодуль.слово, сам.__цМодулиВсего)
