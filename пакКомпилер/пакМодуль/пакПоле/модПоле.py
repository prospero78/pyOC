...
class тПоле:
	def __init__(сам, пДанные):
		сам.секция = пДанные['секция']  # ссылка на тТип
	...
	def __Разделитель_Обрезать(сам):
		...
		"""
		слово_раздел = сам.секция.слова_секции[0]
	...
	def __Двоеточие_Обрезать(сам):
		...
		"""
		слово_двоеточ = сам.секция.слова_секции[0]
	...
	def __Имя_Проверить(сам):
		...
		print("Сравнение длины", len(сам.слова_секции),len(сам.секция.слова_секции))
	...
	def __Тип_Проверить(сам):
		...
		while True:
			...
			слово_тип = сам.секция.слова_секции[0]
	...
	def __Экспорт_Проверить(сам):
		...
		"""
		слово_экспорт = сам.секция.слова_секции[0]
