...
class тПроцедура:
			...
			if слово0.строка =="END":
				...
				if слово1.строка == сам.__имя:
					...
					if слово2.строка == ";": # это точно конец процедуры
						...
						break
			цКонец += 1
		сам.__проц_конец = сам.слова_секции[цКонец + 1]
		print("%Окончание процедуры:", сам.__проц_конец)
	...
	def __Переменные_Проверить(сам):
		...
		Надо проверить.
		"""
		сам.__перем = тПеременные(сам.__корень, сам.слова_секции)
	...
	def __Типы_Проверить(сам):
		...
		Надо проверить.
		"""
		сам.__типы = тТипы(сам.__корень, сам.слова_секции)
	...
	def __Константы_Проверить(сам):
		...
		Надо проверить.
		"""
		сам.__конст = тКонст(сам.__корень, сам.слова_секции)
