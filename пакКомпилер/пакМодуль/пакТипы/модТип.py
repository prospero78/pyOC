...
class тТип:
	...
	def __Имя_Проверить(сам):
		...
		assert слово_имя.ЕслиИмя(), "тТип: имя типа должно быть дпустимым именем, имя=" + имя
		if имя != "END":
	...
	def __Род_Проверить(сам):
		...
		assert сам.слова_секции[0].ЕслиИмя, "тТип: род типа должен быть именем, строка=" + строка_род
		print("Тип род:", строка_род)
	...
	def __Разделитель_Обрезать(сам):
		...
		print("Тип раздел:", строка_раздел)
