...
class тМодуль:
	...
	def Секции_Разбить(сам):
		...
		сам.__слова = {}
		сам.__слова = сам.__типы.слова

		сам.__перем = тПеременные(сам.__корень, сам.__слова)
		сам.__перем.Обработать()
		сам.__слова = {}
		сам.__слова = сам.__перем.слова

		сам.__проц = тПроцедуры(сам.__корень, сам.__слова)
		сам.__проц.Обработать()
		сам.__слова = {}
		сам.__слова = сам.__проц.слова
